...
<head>
    ...
    <title>Knihovna - Přidat novou knihu</title>
    ...
    <style>
        ...
        /* Styl pro inputy, aby ladily s tmavým tématem */
        input, textarea {
        ...
        <div class="max-w-6xl mx-auto px-6 py-5 flex flex-col md:flex-row justify-between items-center">
            ...
            <nav>
                <ul class="flex space-x-8 text-[11px] uppercase tracking-[0.2em] font-semibold text-white/70">
                    ...
                    <li>
                        <a href="<?= BASE_URL ?>/index.php?url=book/create" class="text-[#d4af37] border-b border-[#d4af37] pb-1">Přidat novou knihu</a>
                    </li>
                </ul>
            </nav>
        </div>
            ...
            <form action="<?= BASE_URL ?>/index.php?url=book/store" method="post" enctype="multipart/form-data" class="space-y-8">
                ...
                <div class="flex flex-col space-y-4">
                    ...
                    <label for="images" class="border-2 border-dashed border-white/10 hover:border-[#d4af37]/50 hover:bg-white/5 transition-all cursor-pointer rounded-sm p-8 text-center flex flex-col items-center group">
                        ...
                        <span class="text-[10px] text-neutral-600 uppercase mt-1 tracking-tighter text-white">JPG / PNG / WebP</span>
